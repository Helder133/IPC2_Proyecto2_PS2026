...
public class FreelancerHabilidadService {
    public void insert(FreelancerHabilidadRequest freelancerHabilidadRequest, EnumUsuario rol, int usuarioId) throws SQLException, UserDataInvalidException {
        ...
        if (freelancerHabilidadDAO.validaHabilidad(freelancerHabilidad))
            throw new UserDataInvalidException("El freelancer ya tiene asignada esta habilidad");
        freelancerHabilidadDAO.insert(freelancerHabilidad);
    }

    public void delete(FreelancerHabilidadRequest freelancerHabilidadRequest, EnumUsuario rol, int usuarioId) throws SQLException, UserDataInvalidException {
        if (!EnumUsuario.Freelancer.equals(rol))
