...
public class Nueva_h_cDAO implements CRUD<Nueva_h_c> {
    ...
    private static final String GET_NUEVO_BY_ID = "SELECT * FROM nueva_h_c WHERE solicitud_id = ?";
    private static final String GET_ALL_NUEVO = "SELECT * FROM nueva_h_c";
    private static final String GET_ALL_NUEVO_BY_USUARIO = "SELECT * FROM nueva_h_c WHERE usuario_id = ?";
